...
insert into `wp_productinfo`(`pid`,`ptitle`,`cid`,`uprice`,`feeprice`,`wave`,`company`,`patx`,`patj`) values('9','XX股权','3','300','0.6','10','1','0','0');
...
insert into `wp_userinfo`(`uid`,`username`,`upwd`,`utel`,`utime`,`agenttype`,`otype`,`ustatus`,`oid`,`address`,`portrait`,`lastlog`,`managername`,`comname`,`comqua`,`rebate`,`feerebate`,`usertype`,`wxtype`,`openid`,`nickname`) values('68','admin','f8148923558b9fa886e62e4e7b0358c1','15999999999','1474093027','2','3','0','','','','1475076058','','','','','','0','0','','');
