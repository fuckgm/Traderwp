...
) ENGINE=MyISAM AUTO_INCREMENT=46692 DEFAULT CHARSET=utf8;
CREATE TABLE `au0` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `price` varchar(255) NOT NULL,
...
CREATE TABLE `cl` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `time` (`time`)
) ENGINE=MyISAM AUTO_INCREMENT=47819 DEFAULT CHARSET=utf8;
CREATE TABLE `cu1609` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `price` varchar(255) NOT NULL,
...
CREATE TABLE `cu1611` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `time` (`time`)
) ENGINE=MyISAM AUTO_INCREMENT=46558 DEFAULT CHARSET=utf8;
...
insert into `wp_accountinfo`(`aid`,`uid`,`balance`,`frozen`,`pwd`) values('1','68','2992808.00','','');
...
insert into `wp_accountinfo`(`aid`,`uid`,`balance`,`frozen`,`pwd`) values('103','348','914.00','','');
...
insert into `wp_accountinfo`(`aid`,`uid`,`balance`,`frozen`,`pwd`) values('112','376','0.00','','');
...
insert into `wp_balance`(`bpid`,`bptype`,`bptime`,`bpprice`,`remarks`,`uid`,`isverified`,`cltime`) values('160','充值','1476008735','0.01','开始充值','348','','');
insert into `wp_balance`(`bpid`,`bptype`,`bptime`,`bpprice`,`remarks`,`uid`,`isverified`,`cltime`) values('161','充值','1476010958','0.01','开始充值','376','','');
insert into `wp_balance`(`bpid`,`bptype`,`bptime`,`bpprice`,`remarks`,`uid`,`isverified`,`cltime`) values('162','充值','1476094350','0.01','开始充值','68','','');
...
insert into `wp_bankinfo`(`bid`,`uid`,`bankname`,`province`,`city`,`branch`,`banknumber`,`busername`) values('30','348','','','','','','');
...
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('275','1476008904565','348','建仓','1476008904','80.00','10','0.1t油','914.00','0','huiyuan','1','8.00','6.0','42.60','','-86.00','','412');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('276','1476010858975','68','平仓','1476010858','400.00','10','1t铜','3005256.80','0','admin','1','40.00','50.0','31875.00','31875.00','400.00','0.00','404');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('277','1476010880485','68','平仓','1476010880','8.00','1','0.1t油','3005264.80','0','admin','0','8.00','0.6','42.60','42.60','8.00','0.00','410');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('278','1476010886545','68','平仓','1476010886','1000.00','10','1t油','3006264.80','0','admin','0','100.00','60.0','42.60','42.60','1000.00','0.00','406');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('279','1476010899519','68','建仓','1476010899','80.00','10','0.1t油','3006178.80','0','admin','0','8.00','6.0','42.60','','-86.00','','413');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('280','1476094325539','68','建仓','1476094325','2000.00','10','5t铜','3003878.80','0','admin','1','200.00','300.0','31875.00','','-2300.00','','414');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('281','1476094924999','68','建仓','1476094924','2000.00','10','5000g银砖','3001578.80','0','admin','0','200.00','300.0','4328.00','','-2300.00','','415');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('282','1477990449495','68','平仓','1477990449','80.00','10','0.1t油','3001658.80','0','admin','0','8.00','6.0','42.60','42.60','80.00','0.00','413');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('283','1478520693535','68','建仓','1478520693','8.00','1','0.1t油','3001650.20','0','admin','0','8.00','0.6','42.60','','-8.60','','416');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('284','1478520915514','68','平仓','1478520915','0.00','1','0.1t油','3001650.20','0','admin','0','8.00','0.6','42.60','303.75','0.00','0.00','416');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('285','1478520922975','68','平仓','1478520922','-8550.00','10','5000g银砖','2993100.20','0','admin','0','200.00','300.0','4328.00','4117.00','-8550.00','-10550.00','415');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('286','1478520925100','68','平仓','1478520925','0.00','10','5t铜','2993100.20','0','admin','1','200.00','300.0','31875.00','40330.00','0.00','0.00','414');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('287','1478521452995','68','建仓','1478521452','8.00','1','0.1t油','2993091.60','0','admin','0','8.00','0.6','303.01','','-8.60','','417');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('288','1478527691989','68','平仓','1478527691','0.00','1','0.1t油','2993091.60','0','admin','0','8.00','0.6','303.01','301.74','0.00','0.00','417');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('289','1478786060991','68','建仓','1478786060','8.00','1','0.1t油','2993083.00','0','admin','1','8.00','0.6','303.81','','-8.60','','418');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('290','1478786371515','68','建仓','1478786371','40.00','1','1t铜','2993038.00','0','admin','0','40.00','5.0','40390.00','','-45.00','','419');
insert into `wp_journal`(`id`,`jno`,`uid`,`jtype`,`jtime`,`jincome`,`number`,`remarks`,`balance`,`jstate`,`jusername`,`jostyle`,`juprice`,`jfee`,`jbuyprice`,`jsellprice`,`jaccess`,`jploss`,`oid`) values('291','1478786436525','68','建仓','1478786436','200.00','1','5t铜','2992808.00','0','admin','1','200.00','30.0','40390.00','','-230.00','','420');
...
insert into `wp_managerinfo`(`mid`,`uid`,`poid`,`coid`,`mname`,`brokerid`,`photoid`) values('87','376','','','','32324324324324234324324','');
...
insert into `wp_newsinfo`(`nid`,`ntitle`,`ncontent`,`ncover`,`ncategory`,`ntime`) values('8','123123','123123213','2016-11-11/5825659584b89.png','3','1478793600');
...
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('404','68','8','1','1474982186','10','1476010858','1','31875.00','31875.00','30','20','50.0','0','1474982186979','1t铜','3005256.8','0.0','0');
...
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('406','68','3','0','1474982212','10','1476010886','1','42.60','42.60','50','10','60.0','0','1474982212525','1t油','3006264.8','0.0','0');
...
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('410','68','2','0','1475639122','1','1476010880','1','42.60','42.60','0','0','0.6','0','1475639122505','0.1t油','3005264.8','0.0','0');
...
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('412','348','2','1','1476008904','10','0','0','42.60','0.00','0','0','6.0','0','1476008904565','0.1t油','914.0','0.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('413','68','2','0','1476010899','10','1477990449','1','42.60','42.60','20','20','6.0','0','1476010899519','0.1t油','3001658.8','0.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('414','68','7','1','1476094325','10','1478520925','1','31875.00','40330.00','10','10','300.0','0','1476094325539','5t铜','2993100.2','0.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('415','68','4','0','1476094924','10','1478520922','1','4328.00','4117.00','0','0','300.0','0','1476094924999','5000g银砖','2993100.2','-10550.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('416','68','2','0','1478520693','1','1478520915','1','42.60','303.75','0','0','0.6','0','1478520693535','0.1t油','3001650.2','0.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('417','68','2','0','1478521452','1','1478527691','1','303.01','301.74','0','0','0.6','0','1478521452995','0.1t油','2993091.6','0.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('418','68','2','1','1478786060','1','0','0','303.81','0.00','0','0','0.6','0','1478786060991','0.1t油','2993083.0','0.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('419','68','8','0','1478786371','1','0','0','40390.00','0.00','0','0','5.0','0','1478786371515','1t铜','2993038.0','0.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('420','68','7','1','1478786436','1','0','0','40390.00','0.00','0','0','30.0','0','1478786436525','5t铜','2992808.0','0.0','0');
...
insert into `wp_productinfo`(`pid`,`ptitle`,`cid`,`uprice`,`feeprice`,`wave`,`company`,`patx`,`patj`) values('9','XYSK','3','100','0.6','5','1','0','0');
...
insert into `wp_userinfo`(`uid`,`username`,`upwd`,`utel`,`utime`,`agenttype`,`otype`,`ustatus`,`oid`,`address`,`portrait`,`lastlog`,`managername`,`comname`,`comqua`,`rebate`,`feerebate`,`usertype`,`wxtype`,`openid`,`nickname`) values('68','admin','f8148923558b9fa886e62e4e7b0358c1','15999999999','1474093027','2','3','0','','','','1478847411','','','','','','0','0','','');
...
insert into `wp_userinfo`(`uid`,`username`,`upwd`,`utel`,`utime`,`agenttype`,`otype`,`ustatus`,`oid`,`address`,`portrait`,`lastlog`,`managername`,`comname`,`comqua`,`rebate`,`feerebate`,`usertype`,`wxtype`,`openid`,`nickname`) values('348','huiyuan','8f8da22fa42398b6cc321b74f8be12da','18710484848','1464175666','0','2','0','68','mdomo  ','','1476008625','adminwp888','都默默都快没豆肯定怕【','飞毛士大夫','60','0','0','0','','');
...
insert into `wp_userinfo`(`uid`,`username`,`upwd`,`utel`,`utime`,`agenttype`,`otype`,`ustatus`,`oid`,`address`,`portrait`,`lastlog`,`managername`,`comname`,`comqua`,`rebate`,`feerebate`,`usertype`,`wxtype`,`openid`,`nickname`) values('375','','819a14b382dfe220a5c0093a369e835e','','1475658197','0','2','0','68','','','1475658219','admin','','','10','','0','0','','');
insert into `wp_userinfo`(`uid`,`username`,`upwd`,`utel`,`utime`,`agenttype`,`otype`,`ustatus`,`oid`,`address`,`portrait`,`lastlog`,`managername`,`comname`,`comqua`,`rebate`,`feerebate`,`usertype`,`wxtype`,`openid`,`nickname`) values('376','大家好','63a9587d56532a43a1f87dcc61fe0180','123445667777','1476010903','0','2','0','68','似懂非懂时代复分','','1476010915','admin','分为惹我惹我','23423432432432','','','0','0','','');
...
insert into `wp_webconfig`(`id`,`isopen`,`webname`,`begintime`,`endtime`,`notice`,`isnotice`) values('1','1','微盘测测','','','hahahaha','0');
