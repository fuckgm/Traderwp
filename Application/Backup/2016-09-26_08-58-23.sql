...
insert into `wp_accountinfo`(`aid`,`uid`,`balance`,`frozen`,`pwd`) values('1','68','10000835060.00','','');
...
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('395','68','2','0','1474736692','1','0','0','42.60','0.00','0','0','0.6','0','1474736692521','0.1t油','10000835176.0','0.0','0');
...
insert into `wp_userinfo`(`uid`,`username`,`upwd`,`utel`,`utime`,`agenttype`,`otype`,`ustatus`,`oid`,`address`,`portrait`,`lastlog`,`managername`,`comname`,`comqua`,`rebate`,`feerebate`,`usertype`,`wxtype`,`openid`,`nickname`) values('68','admin','f8148923558b9fa886e62e4e7b0358c1','15999999999','1474093027','2','3','0','','','','1474851064','','','','','','0','0','','');
