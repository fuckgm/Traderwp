...
insert into `wp_accountinfo`(`aid`,`uid`,`balance`,`frozen`,`pwd`) values('1','68','10000835176.00','','');
...
insert into `wp_userinfo`(`uid`,`username`,`upwd`,`utel`,`utime`,`agenttype`,`otype`,`ustatus`,`oid`,`address`,`portrait`,`lastlog`,`managername`,`comname`,`comqua`,`rebate`,`feerebate`,`usertype`,`wxtype`,`openid`,`nickname`) values('68','admin','f8148923558b9fa886e62e4e7b0358c1','15999999999','1474093027','2','3','0','','','','1474736660','','','','','','0','0','','');
