...
class SuperController extends Controller {
	...
	public function esystem(){
		...
		elseif($threelevel!=""){
            $result = $config->where($where)->setField('threelevel',$threelevel);
            if($result){
                $this->ajaxReturn("修改成功");
            }else{
                $this->ajaxReturn("修改失败");
		...
		elseif($buylv!=""){
            $result = $config->where($where)->setField('buylv',$buylv);
            if($result){
                $this->ajaxReturn("修改成功");
            }else{
                $this->ajaxReturn("修改失败");
		...
		elseif($rate!=""){
            $result = $config->where($where)->setField('rate',$rate);
            if($result){
                $this->ajaxReturn("修改成功");
            }else{
                $this->ajaxReturn("修改失败");
