...
class UserController extends Controller
{
   ...
   public function reg()
        ...
        {// 判断提交方式 做不同处理
            ...
            if ($code == $verify) {
                ...
                */                 
                ...
                $utels = $user->where('utel='.$data['utel'])->find();
    ...
    public function smsverify()
    {
        ...
        $post_data = array();
        $post_data['uid'] = 'suskart';
        $post_data['pwd'] = 'd3e2d1165e7bd3702ddddd9ab75e8685';
        //$post_data['content'] = '【秒盈】您的验证码是:' . $code;
        $post_data['content'] = '欢迎加入HCW家园，账户验证码".$code."【HCW家园】';
        ...
        $code = $this->mescontent();
				$_SESSION['code'] = $code;
				$content = '你好！手机验证码是:'.$code.'【聚富圣汇社区】';
				$url = 'http://api.sms.cn/sms/?ac=send&uid=suskart&pwd=d3e2d1165e7bd3702ddddd9ab75e8685&mobile='.$_REQUEST['tel'].'&content='.$content;
				//return $url;die;
