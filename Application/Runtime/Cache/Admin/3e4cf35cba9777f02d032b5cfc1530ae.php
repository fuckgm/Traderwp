...
<div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                ...
                <div class="row-fluid table">
                    ...
                    <div class="qjcz">
					截止<script type="text/javascript">var myDate = new Date();document.writeln(myDate.getFullYear()+'年'+(myDate.getMonth()+1)+'月'+myDate.getDate()+'日');</script>，共有<font color="#f00" size="4"><?php echo ($ucount); ?></font>个会员完成注册，交易数量已达<font color="#f00" size="4"><?php echo ($onumber); ?></font>元，所有账户余额累计<font color="#f00" size="5"><?php echo ($anumber); ?></font>元
				</div>
                </div>
