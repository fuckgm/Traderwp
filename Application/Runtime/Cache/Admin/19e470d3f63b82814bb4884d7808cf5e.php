                    	...
                    	<?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="first <?php if($vo["ostaus"] == 0): ?>create<?php else: endif; ?>">
	                            ...
	                            <td class="sellprice">
	                            	...
	                            	<?php else: ?>
										...
										<span <?php if($vo["cid"] == 1): ?>class="you drop"<?php elseif($vo["cid"] == 2): ?>class="baiyin drop"<?php elseif($vo["cid"] == 4): ?>class="pricebt drop"<?php else: ?>class="tong drop"<?php endif; ?>></span><?php endif; ?>
	                            </td>
	                            <td>
