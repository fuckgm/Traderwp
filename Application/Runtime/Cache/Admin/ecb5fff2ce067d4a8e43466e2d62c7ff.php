...
<body>
    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="users-list">
                ...
                <table class="table table-hover">
                    ...
                    <tr class="first">
                        ...
                        <td>
						 ...
						 <!--td>
                            <font color="#f00" size="3"><?php echo ($gl['buytime']); ?></font>秒
                        </td-->
                        <td>
                            <font color="#f00" size="3"><?php echo ($gl['uprice']); ?></font>秒
                        </td>
                        <td>
                        	<?php echo ($gl['patj']); ?>
                        </td>
                        ...
                        <td>
							<em 
							<?php if($gl["cid"] == 1): ?>class="you"
							<?php elseif($gl["cid"] == 2): ?>class="baiyin"
							<?php elseif($gl["cid"] == 3): ?>class="tong"
							<?php elseif($gl["cid"] == 4): ?>class="pricebt"
							<?php elseif($gl["cid"] == 5): ?>class="eurusd"
							<?php else: endif; ?>></em>
                        </td>
						<!--<td>
                            <?php echo ($gl['cname']); ?>
            ...
            <input id="pricebt" type="hidden" value=""/>
            </form>
...
<script type="text/javascript">  
	...
	function butt(){  
		...
		$.ajax({  
			type: "post",  
			url: "<?php echo U('Goods/pricebt');?>",         
			success: function(data) {
				//最新白银价
				$('.pricebt').text(data[0]);
				$('#pricebt').val(data[0]);
				if(data[0]<toprice){
					$('.pricebt').attr("class","pricebt drop");
				}else if(data[0]==toprice){}else{
					$('.pricebt').attr("class","pricebt rise");
				}   
			},  
		});
	}
