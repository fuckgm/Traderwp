        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span8 column">
					...
					<div class="field-box" style="width: 45%;">
						<label>时间：</label>
						<input class="span2" type="text" data-toggle="tooltip" data-trigger="focus" title="时间：" data-placement="right" name="uprice" value="<?php echo ($editgood['uprice']); ?>"/>
					</div>
					<div class="field-box" style="width: 50%;">
						<label>手续费：</label>
					...
					<div class="field-box" style="width: 45%;">
						<label>单位：</label>
						<input class="span2" type="text" data-toggle="tooltip" data-trigger="focus" title="单位" data-placement="right" value="<?php echo ($editgood['company']); ?>" name="company"/>
					</div-->
					<div class="field-box" style="width: 50%;">
						<label>外盘价格：</label>
