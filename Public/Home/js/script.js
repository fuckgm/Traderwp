 ...
 function  abc(code){
	  ...
	  get_url = function(is_iframe){
		  ...
		  if(is_iframe==1){
			 ...
			 // $('.trend-chart').html('<iframe id="chart" class="efc" width="100%" height="750" scrolling="no" style="position: absolute; top: -0px; left: 0px;" frameborder="0" src="'+ url + '?' + parameter_str +'"></iframe>');
		  }
